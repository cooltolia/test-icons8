...
export default class CustomSelect {
    ...
    toggleOptionsList(e) {
        ...
        if (e.type === 'click') {
            ...
            this.dropdown.setAttribute('aria-expanded', this.dropdown.classList.contains('opened').toString());
    ...
    singleSelectLogic(e, selectedValue) {
        ...
        if (typeof this.options.onSelect === 'function') {
            ...
            if (this.options.valueType) res[this.options.valueType] = this.options.valueType;
